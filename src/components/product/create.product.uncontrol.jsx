...
const CreateProductUncontrol = (props) => {
    const { loadProducts, isCreateOpen, setIsCreateOpen } = props;
    ...
    const handleSubmitBtn = async (values) => {
        ...
        if (resUpload.data) {
            ...
            const resBook = await productApi.create({
                mainText, author, price,
                quantity, category, thumbnail
            });
...
export default CreateProductUncontrol;
