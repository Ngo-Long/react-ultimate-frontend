...
const UpdateProductControl = (props) => {
    const {
        dataUpdate, setDataUpdate, loadProducts,
    ...
    const handleUpdateProduct = async (newThumbnail) => {
        const res = await productApi.update(
            {
                "_id": id, mainText, author,
    ...
    const handleSubmitBtn = async () => {
        ...
        //step 2: update book
        await handleUpdateProduct(newThumbnail);
    }
...
export default UpdateProductControl;